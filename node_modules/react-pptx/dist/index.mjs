    ...
    return __generator(this, function (_k) {
        switch (_k.label) {
            ...
            case 1:
                ...
                return [3 /*break*/, 8];
            case 2: return [4 /*yield*/, fetch(object.src[object.src.kind])];
            case 3:
                req = _k.sent();
...
export { Image, Presentation, Shape, Slide, Text, isImage, isShape, isText, isTextLink, normalizeJsx, render };
