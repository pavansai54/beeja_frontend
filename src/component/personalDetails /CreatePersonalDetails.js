			...
			<Container>
				<Table>
					...
					<TableRow>
						<TableColumn>
							{' '}
							<Lable htmlFor='PAN'> PAN: </Lable>
						</TableColumn>
						<TableColumn>
							<Input name='PanCard_No' onChange={handleChange} required />
						</TableColumn>
					</TableRow>
					<Break />
					<TableRow>
						...
						<TableColumn>
							<Input name='Account_No' onChange={handleChange} required />
						</TableColumn>
					</TableRow>
					<Break />
					<TableRow>
						<TableColumn>
							<Lable htmlFor='IFSC Code'>IFSC Code: </Lable>
						</TableColumn>
						<TableColumn>
							<Input name='Ifsc_Code' onChange={handleChange} required />
						</TableColumn>
					</TableRow>
					<Break />
					<TableRow>
